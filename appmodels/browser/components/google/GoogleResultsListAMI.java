...
public class GoogleResultsListAMI extends AppModelBase {		private SdasdGoogleSearchPage SdasdGoogleSearchPage;
	private ResultListContainer ResultListContainer;
	
	public GoogleResultsListAMI(TestObject contextTestObject) throws GeneralLeanFtException
	{
		setName("GoogleResultsListAMI");
				SdasdGoogleSearchPage = new SdasdGoogleSearchPage(contextTestObject, this);
		ResultListContainer = new ResultListContainer(contextTestObject, this);
		rebuildDescriptions();
	}	

			public SdasdGoogleSearchPage SdasdGoogleSearchPage() { return SdasdGoogleSearchPage; }
		public ResultListContainer ResultListContainer() { return ResultListContainer; }

		public class SdasdGoogleSearchPage extends PageNodeBase
	{

		
								public SdasdGoogleSearchPage(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);

			
			setDisplayName("sdasd - Google Search");
		}
	...
	public class ResultListContainer extends WebElementNodeBase
	{

		
								public ResultListContainer(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);

			
			setDisplayName("ResultListContainer");
		}
		...
		protected com.hp.lft.sdk.web.WebElementDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.WebElementDescription.Builder().id("res").tagName("DIV").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
