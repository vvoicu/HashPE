...
public class FlightFinderAMI extends AppModelBase {		private TripType TripType;
	...
	public FlightFinderAMI(TestObject contextTestObject) throws GeneralLeanFtException
	{
		setName("FlightFinderAMI");
				TripType = new TripType(contextTestObject, this);
		...
		public class TripType extends RadioGroupNodeBase
	{

		
								public TripType(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
		...
		protected com.hp.lft.sdk.web.RadioGroupDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.RadioGroupDescription.Builder().type("radio").tagName("INPUT").name("tripType").build();
			}catch(Exception e){
